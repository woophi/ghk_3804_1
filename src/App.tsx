      ...
      <div className={appSt.bottomBtn}>
        {step !== 0 && (
          <button
            ...
            onClick={() => {
              if (step === 7) {
                window.gtag('event', 'back_3804_click_p4_var1');
              } else {
                window.gtag('event', `back_3804_click_p${step + 1}_var1`);
              }
        ...
        {step === 7 ? (
          <>
            <ButtonMobile
              ...
              onClick={() => window.gtag('event', 'activate_3804_click_p4_var1')}
            >
              Подключить
            </ButtonMobile>
            <a
              ...
              onClick={() => window.gtag('event', 'no_activate_3804_click_p4_var1')}
          ...
          <ButtonMobile
            ...
            className={appSt.btn()}
            onClick={() => {
              window.gtag('event', `next_3804_click_p${step + 1}_var1`);
